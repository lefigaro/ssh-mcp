...
This project is a fork of the original [ssh-mcp](https://github.com/tufantunc/ssh-mcp) created by [Tufan Tunç](https://github.com/tufantunc). We are grateful for his work in creating the foundation for this tool.
